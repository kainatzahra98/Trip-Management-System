...
<html>
<head>
<title>TMS | Trip Management System</title>
...
<?php $sql = "SELECT * from tbltourpackages order by random() limit 4";
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					...
					<p><b>Duration</b> <?php echo htmlentities($result->Packagestartdate);?> to <?php echo htmlentities($result->Packageenddate);?></p>
