...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<?php echo htmlentities($result->Packagestartdate);?>
				<input class="date" id="datepicker" type="hidden" placeholder="dd-mm-yyyy"  name="fromdate" value="<?php echo htmlentities($result->Packagestartdate);?>">
			</div>
			<div class="bnr-right">
				<label class="inputLabel">To</label>
				<?php echo htmlentities($result->Packageenddate);?>
				<input class="date" id="datepicker1" type="hidden" placeholder="dd-mm-yyyy" name="todate" value="<?php echo htmlentities($result->Packageenddate);?>">
			</div>
			</div>
