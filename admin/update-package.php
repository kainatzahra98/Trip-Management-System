...
$pstart=$_POST['packagestartdate'];	
$pend=$_POST['packageenddate'];	
$pimage=$_FILES["packageimage"]["name"];
$sql="update TblTourPackages set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails,Packagestartdate=:pstart,Packageenddate=:pend where PackageId=:pid";
...
$query->bindParam(':pstart',$pstart,PDO::PARAM_STR);
...
<div class="form-group">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package start Date</label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="packagestartdate" id="packagestartdate" value="<?php echo htmlentities($result->Packagestartdate);?>"  required>
									</div>
								</div>

								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package End Date</label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="packageenddate" id="packageenddate" value="<?php echo htmlentities($result->Packageenddate);?>" required>
									</div>
								</div>

<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Facilities</label>
									<div class="col-sm-8">
