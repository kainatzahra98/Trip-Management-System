...
<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="packagestartdate" id="packagestartdate" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="packageenddate" id="packageenddate" required>
									</div>
								</div>
